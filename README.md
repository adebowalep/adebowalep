<img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&pause=1000&color=32CD32&center=true&vCenter=true&width=800&lines=Hi+there+%F0%9F%91%8B+I%27m+Suleiman+Adebowale+Ojo;Data+Scientist+%2F+Data+Engineer+(ex-Amadeus);I+build+lakehouse+pipelines,+dashboards+%26+ML+that+ship." alt="Typing SVG" />
...
| Domain                              | Stack                                                                      |
| ----------------------------------- | -------------------------------------------------------------------------- |
| **Data Engineering & Lakehouse**    | PySpark/Spark, SQL, Delta Lake, Azure Databricks, Pandas, dbt *(learning)* |
| **Streaming & Big Data**            | Apache Kafka, Spark, Hadoop/Hive, NoSQL                                    |
| **Cloud & Data Platforms**          | Microsoft Fabric, Azure Data Factory, Azure Databricks, AWS (Redshift)     |
| **MLOps & Production ML**           | MLflow, model evaluation pipelines, deployment-ready workflows             |
| **DevOps & Automation**             | Git, Jenkins, Docker, Kubernetes, Helm, Terraform, Argo CD, SonarQube      |
| **Observability / Monitoring**      | Prometheus                                                                 |
| **Analytics & BI**                  | Power BI (DAX), Tableau, Deneb (Vega-Lite), Charticulator                  |
| **Machine Learning / Data Science** | scikit-learn, PyTorch, experimentation (A/B testing, regression)           |
...
| [🗺️ Landmark Classifier (CNN)](https://github.com/adebowalep/Landmark-classifier)                                                         | CNN-powered app that predicts the most likely location/landmark in a photo (from scratch + transfer learning).            | Python, Deep Learning, CNNs, Transfer Learning      |
| [💬 Text Translation + Sentiment Analysis (Transformers)](https://github.com/adebowalep/Text_Translation_and_Sentiment_Analysis_using_Transformers) | Notebook project combining translation and sentiment classification using transformer models.                              | Python, NLP, Transformers, Jupyter Notebook         |
